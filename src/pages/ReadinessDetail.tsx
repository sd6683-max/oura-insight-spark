      ...
      <div className="w-full max-w-[390px] flex flex-col min-h-screen">
        <div className="flex-1 overflow-y-auto px-5 pt-14 pb-4">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-lg font-medium text-foreground">Readiness</span>
          ...
          {/* Toggle */}
          <div className="flex bg-accent rounded-lg p-0.5 mb-5">
            <button
          ...
          <div className="relative min-h-[140px] mb-6">
            ...
            >
              <h2 className="text-2xl font-light text-foreground mb-4" style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}>
          ...
          {/* Contributors */}
          <div>
            <h3 className="text-xl font-semibold text-foreground mb-2">Contributors</h3>
